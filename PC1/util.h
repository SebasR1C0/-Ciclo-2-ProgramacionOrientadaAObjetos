...
public:
	...
	~CDonaciones(){}
	 ...
	 void datos() {
		 cout << "La cantidad de donaciones a la seccion Secundaria es: " << totalS << endl;
		 cout << "La cantidad de donaciones a la seccion Primaria es: " << totalP << endl;
		 cout << "La cantidad de donaciones a la seccion Inicial es: " << totalI << endl;
	 }
};
class CMonto {
public:
